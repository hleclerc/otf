...
ext_modules.append(Extension(
    "pybind_PowerDiagram",
    sources=[
        'otf/pybind_PowerDiagram.cpp',

        "../../src/otf/support/VtkOutput.cpp",

        "../../src/otf/PowerDiagram/PowerDiagramFactory_CGAL.cpp",
        "../../src/otf/PowerDiagram/PowerDiagramFactory.cpp",

        "../../src/otf/PowerDiagram/PowerDiagram_CGAL_2.cpp",
        "../../src/otf/PowerDiagram/PowerDiagram_CGAL_3.cpp",
        "../../src/otf/PowerDiagram/PowerDiagram.cpp",

        "../../src/otf/PowerDiagram/PowerDiagramCell_CGAL_2.cpp",
        "../../src/otf/PowerDiagram/PowerDiagramCell_CGAL_3.cpp",
        "../../src/otf/PowerDiagram/PowerDiagramCell.cpp",
    ],
...
setup(
    ...
    description="Semi-discrete optimal transport",
    long_description="""
        Optimal transport for the masses...
    """,
    long_description_content_type="text/markdown",
    url="https://github.com/sd-ot/otf",
    classifiers=[
